...
void ChangeHeadWnd::initUi()
{
    ...
    _pTitleLab = new QLabel("修改头像", this);
    ...
    auto *changeBtn = new QPushButton("选取头像", this);
    auto *makeSureBtn = new QPushButton("完成", this);
...
void ChangeHeadWnd::showChangeHeadWnd()
{
    ...
    QString headPath = QFileDialog::getOpenFileName(this, "选择头像文件",
