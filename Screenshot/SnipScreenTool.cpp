...
{
    m_currentType = drawNotSet;
    m_currentType = (type==SnipScreenToolBar::TOOLTYPE::SNIP_TOOLBAR_RECT?drawRectangle:m_currentType);
    m_currentType = (type==SnipScreenToolBar::TOOLTYPE::SNIP_TOOLBAR_RING?drawEllipse:m_currentType);
    m_currentType = (type==SnipScreenToolBar::TOOLTYPE::SNIP_TOOLBAR_PEN?drawPen:m_currentType);
    m_currentType = (type==SnipScreenToolBar::TOOLTYPE::SNIP_TOOLBAR_TEXT?drawText:m_currentType);
    m_currentType = (type==SnipScreenToolBar::TOOLTYPE::SNIP_TOOLBAR_ARROW?drawArror:m_currentType);
