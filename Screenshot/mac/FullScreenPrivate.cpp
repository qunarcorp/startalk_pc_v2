...
FullScreenPrivate::FullScreenPrivate()
= default;
...
//    destTopRect = QRect(screenx,screeny,width,height);
    ...
    destTopRect = deskTop->availableGeometry(QCursor::pos());
    destTopRect = QRect(destTopRect.x()*_pr, destTopRect.y() * _pr, destTopRect.width() * _pr, destTopRect.height() * _pr);
    return destTopRect;
}
