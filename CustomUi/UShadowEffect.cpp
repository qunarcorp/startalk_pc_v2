#include "UShadowEffect.h"

#include <QPainter>

UShadowEffect::UShadowEffect(QObject *parent) :
...
void UShadowEffect::draw(QPainter *painter)
{
...
QRectF UShadowEffect::boundingRectFor(const QRectF &rect) const
{
